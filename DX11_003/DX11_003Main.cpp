...
DX11_003Main::DX11_003Main(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void DX11_003Main::CreateWindowSizeDependentResources() 
{
...
void DX11_003Main::OnDeviceLost()
{
...
void DX11_003Main::OnDeviceRestored()
{
